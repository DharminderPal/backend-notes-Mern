...
// res.send({
//  headers,body,
// ip,path,protocol,hostname, method ,url, route
...
// //   name:"dharminder",
// // });
// res.send(__dirname+'/index.html',{root: __dirname}) /* ecma script + is this */ 
